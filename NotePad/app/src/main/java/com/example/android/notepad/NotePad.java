...
public final class NotePad {
    ...
    public static final class Notes implements BaseColumns {
        ...
        public static final String ASC_SORT_ORDER="modified ASC";

        public static final  String TITLE_SORT_DESC="title DESC";

        public static final  String TITLE_SORT_ASC="title ASC";
